...
const SingleOffer = ({ offer, reviews }: TSingleOfferProps) => {

  //const { id, title, type, price, isFavorite, isPremium, rating, images, bedrooms, maxAdults, host, description, goods } = offer;
